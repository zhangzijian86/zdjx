...
$yuanxinuser=$_GET['yuanxinuser'];
$yuanxinpassword=$_GET['yuanxinpassword'];
...
function login_header( $title = 'Log In', $message = '', $wp_error = '' ) {
	...
	<body class="login <?php echo esc_attr( implode( ' ', $classes ) ); ?>" onload="abc()" >
	<div id="login">
...
function abc(){
        //	alert("onload"+$_GET['yuanxinuser']+$_GET['yuanxinpassword']);
	//alert("onload"+"<?php echo $yuanxinuser; ?>"+"<?php echo $yuanxinpassword; ?>");
	document.getElementById("user_login").value = "<?php echo $yuanxinuser; ?>";
	document.getElementById("user_pass").value = "<?php echo $yuanxinpassword; ?>";
